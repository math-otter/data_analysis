...
# 데이터 생성
log_file_name = r'data/000002_skill_usage_log.txt'
csv_file_name = r'data/000002_skill_usage_time.csv'
human(log_file_name)
...
for skill in skills:
    ...
    plt.tight_layout()
    plt.savefig(r'images/2_visualization_human_{}.png'.format(skill))
